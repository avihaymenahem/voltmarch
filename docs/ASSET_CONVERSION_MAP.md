...
| P2 | `haystack`, `containerStack`, `barrel` | Yard Props | PROP | integrated | Offline-baked authored silhouettes use topology-safe LOD1/LOD2 reductions and 12-triangle casters. They share the ImageGen-derived metal/wood/hay/stone `prop-surface-v1` 1K/512/512 PBR atlas. |
