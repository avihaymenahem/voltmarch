...
> Armour and volume. Slower, heavier, hits like a building.

Rust, heat and slab. Riveted seams every 35 centimetres, furnace-orange glow behind the plate, olive
and oxide paint applied in the field rather than in a shop. Nothing in the Soviet roster is elegant
and nothing in it needs to be. The doctrine is a single sentence repeated at every tier: **the
answer to a heavy tank is a heavier tank.**
...
will lose a lot of them and it will not matter much.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Conscript | 100 | 4 s | Barracks | 100 | Infantry | 3.4 | AK Pattern, 16 x3, small arms | 17 m | yes | Cheap, expendable, everywhere. The cheapest body in either shared-pool army |
...
Two cheap defences from the first minute — the Sentry Gun and the Flame Tower — is a real Soviet
advantage over the Allies, who only have the Pillbox. The Flame Tower has the shortest range of any
defensive structure in the game at 18 m, but a 3.2 m high-explosive splash on a half-second cycle is
brutal against anything on foot.
...
**War Commissar** — 1500 credits, 20 seconds, needs a Barracks and a Radar Dome. 520 HP (the
toughest commander in the game), 3.5 m/s, 30 m of sight, and he carries a full Tesla Coil: 120
