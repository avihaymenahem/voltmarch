...
base-building RTS, and VOLTMARCH speaks it fluently rather than reinventing it. What is new is the
armies. Two of them (the Allied Forces and the Soviet Union) share a common pool of buildings and
support units and diverge at the interesting end. The other two (the Meridian Pact and the
Reclamation) are complete parallel trees, from their own construction yard to their own
superweapon, and they play nothing like the first two or like each other.
...
| [Maps](/avihaymenahem/voltmarch/wiki/Maps) | The ten battlefields and what each one rewards. |
