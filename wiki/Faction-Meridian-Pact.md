...
> Nothing the Pact fields touches the ground. Solar tech, hovering hulls.

Bone ceramic and jade, with gold light bleeding out of every collector seam. The Pact does not paint
its hardware olive or chrome it — it corbels it, in warm plate, and hangs the whole thing a few
centimetres above the dirt on a skirt. Their buildings are a Conclave, a Chapterhouse, an Oculus and
a Reliquary; their commander is a Hierarch; their engineer is an Artificer. This is an army that
thinks of a war as an undertaking with liturgy attached, and it fights like one: at range, in
order, and never in a scrum.

Two rules make the whole faction, and every number on this page is one of them.

**Nothing touches the ground.** Every Pact vehicle and ship hovers, which makes the entire army
amphibious — any lake on the map is a road, and a second front can be opened across water that other
armies have to build a Naval Yard to cross. The Kestrel goes further and actually flies. The price
is paid twice: a skirt cannot crush a man, so **the Pact is the only faction in the game that cannot
run over infantry**, and the main line sits one armour class below the tracked equivalent.
...
for 100 — the cheapest power per credit in the game — so the Pact affords its Chapterhouse off one
array where the other armies need a second plant. That is the whole opening. It is also why the
array has **420 hit points** — barely half a Power Plant's 800, and softer than any other building
in the game that is not a wall.

Your economy is not richer, it is more exposed. A Sun Collector carries 450 credits against the
shared harvester's 700, but moves 40% faster and costs 400 less — roughly the same throughput per
minute, spent on more round trips through open ground. You recover from losing a collector faster
than anyone; you also lose them more often.

## Infantry

Trained at the **Chapterhouse**.
...
Built at the **Forgeyard**. Everything here hovers, so everything here crosses water and none of it
crushes anything.
...
Built at the **Forgeyard**. No airfield, no rearm, no fuel — a Kestrel takes off and stays up until
it dies.

| Unit | Cost | Time | Needs | HP | Armour | Speed | Weapon | Range | Air | What it is for |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Kestrel Gunship **(locked)** | 1100 | 15 s | Forgeyard, Oculus | 210 | Light | 12.0 | Kestrel Pod, 44 x2, rocket, 1.8 m splash | 22 m | yes | Fast guided rocket pods. Tank guns cannot elevate, so a Kestrel over an armoured column is untouchable by most of it. Rockets hurt armour and buildings alike, and 36 m of sight makes it an excellent scout |
...
| --- | --- | --- | --- | --- | --- | --- |
| Conclave | 3000 | 40 s | — | 1900 | -20 | Deployed from a Pactworks Carryall, not built. Builds every structure within 56 m |
| Solar Array | 350 | 8 s | Conclave | **420** | **+160** | The cheapest power per credit in the game, and softer than any other building in the game bar walls and gates |
| Ore Cistern | 2000 | 24 s | Solar Array | 1150 | -30 | Unloads collectors, adds 2000 to your bank cap, and **ships with a free Sun Collector** |
| Chapterhouse | 500 | 10 s | Solar Array | 750 | -20 | Trains Pact infantry |
| Forgeyard | 2000 | 24 s | Ore Cistern | 1150 | -40 | Builds every Pact hull. Sets a rally point |
...
feel like a different shape, not like a discount — the Solar Array is the only bargain, and it is
paid for in hit points.
...
the shared-pool Gate to let your own column through a wall run — plan your perimeter accordingly.

**The Pact has no dedicated anti-air emplacement.** The Helios Spire elevates and will engage
...
**Hierarch** — 1500 credits, 20 seconds, needs a Chapterhouse and an Oculus. 430 HP (the lightest
commander in the game), 4.0 m/s (the fastest), and 36 m of sight (the widest). He carries a Focus
Lance, the same armour-piercing gun the Solarch mounts, and he cannot shoot at aircraft.

**Prism Focus** — 45-second cooldown, 18 m radius. 210 damage to every enemy standing near the
commander. The only commander ability in the game that deals damage rather than repositioning,
protecting or healing, which makes the Hierarch a genuinely offensive hero — and also the reason he
has to walk into a fight to be useful with 430 hit points.
