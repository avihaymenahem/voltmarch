...
tree. Neither draws a single row from the shared pool, which has one consequence a new player will
notice early: they each have their own wall (the Rampart, the Scrap Barricade) but **neither has a
gate at all**, because the Gate lives in the pool.

---

## At a glance

| | Allied Forces | Soviet Union | Meridian Pact | The Reclamation |
| --- | --- | --- | --- | --- |
...
Damage is a warhead multiplied by the target's armour class. The table below is the whole counter
system; the rest is positioning.

| Warhead | vs Infantry | vs Light | vs Medium | vs Heavy | vs Concrete |
| --- | --- | --- | --- | --- | --- |
| Small arms | 1.00 | 0.55 | 0.28 | **0.10** | 0.18 |
| Autocannon | 0.80 | **1.00** | 0.65 | 0.35 | 0.35 |
| Armour-piercing | 0.35 | 0.85 | **1.00** | **1.00** | 0.55 |
| High explosive | 0.90 | 0.80 | 0.65 | 0.50 | **1.00** |
| Rocket | 0.55 | 0.95 | 0.90 | 0.95 | 0.90 |
| Tesla (arc) | **1.60** | 0.95 | 0.85 | 0.90 | 0.60 |
| Prism (beam) | 1.10 | 0.95 | 0.95 | 0.90 | 0.80 |
...
Only some guns can shoot upward. A weapon answers aircraft only if it is built to: rifles and
carbines do, autocannon and rocket launchers do, tank cannons and siege beams and naval deck guns
do not. Check the "Air" column on each faction's roster tables.

---

## Superweapons

Six structures, four effects. Each costs a flat **-150 power**, by a wide margin the heaviest single
draw in the game, and each is gated on its army's tech building. The charge timer pauses if you lose
the structure or the grid; it does not reset.
...
**The asymmetry is real and it is not subtle.** The Allies and the Soviets get two superweapons each
and can field both at once. The Pact and the Reclamation get one apiece.
...
| Commander | Faction | HP | Ability | Radius | Cooldown | Effect |
| --- | --- | --- | --- | --- | --- | --- |
| Field Marshal | Allies | 460 | Chrono Rally | 34 m | 50 s | Teleports up to 6 nearby friendly units to a ring around him |
| War Commissar | Soviets | 520 | Iron Will | 16 m | 60 s | Friendlies in radius cannot be harmed for 5 seconds |
| Hierarch | Meridian Pact | 430 | Prism Focus | 18 m | 45 s | 210 damage to every enemy standing near him |
| Scrap Baron | Reclamation | 470 | Salvage Call | 22 m | 40 s | Strips up to 8 nearby wrecks for 120 credits each and heals friendlies for 30% of max HP |
...
entire economic tree with the Allies, so nothing you learn is wasted when you switch.
...
out-ranges its opposite number by a metre or three and under-damages it, so a Pact line wins a
standoff and loses a brawl. Everything hovers, so any lake is a road. But the whole line is Light
armour, nothing you own can crush a single infantryman, and a Solar Array has 420 hit points.

**The Reclamation last.** It is the easiest army to *get* and the hardest army to *win* with. Its
buildings and units are the cheapest in the game and a Scrap Picker is 90 credits and three seconds,
so you will always have an army. Then you discover that your guns reach 14–20 m against everyone
else's 22–26, that nothing you own has a turret so it must face what it shoots, and that arcs at
0.60 against concrete mean your entire ability to break a base is one Slaghurler and a man with a
satchel. Extremely rewarding once it clicks. Not a first faction.
