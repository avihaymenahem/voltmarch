...
const SPOTLIGHT_CONTRACT: Readonly<Record<string, string>> = {
  'vm-dock-map': 'apps/game/src/ui/Sidebar.ts',
  'vm-dock-selection': 'apps/game/src/ui/Sidebar.ts',
  'vm-dock-build': 'apps/game/src/ui/Sidebar.ts',
  'vm-grid': 'apps/game/src/ui/Sidebar.ts',
  'vm-resources': 'apps/game/src/ui/Sidebar.ts',
  'vm-res-credits': 'apps/game/src/ui/Sidebar.ts',
  'vm-objectives': 'apps/game/src/ui/Objectives.ts',
};
...
describe('tutorial — the shell launches and tears it down correctly', () => {
  ...
  const menu = readFileSync(join(ROOT, 'apps/game/src/shell/MainMenu.ts'), 'utf8');
  const tutorial = readFileSync(join(ROOT, 'apps/game/src/shell/Tutorial.ts'), 'utf8');
  const progression = readFileSync(join(ROOT, 'apps/game/src/progression/progression.system.ts'), 'utf8');
  const tutorialSystem = readFileSync(join(ROOT, 'apps/game/src/shell/tutorial.system.ts'), 'utf8');
  const inputSystem = readFileSync(join(ROOT, 'apps/game/src/input/input.system.ts'), 'utf8');
