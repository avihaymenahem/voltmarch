...
const FAMILIES: readonly AssetFamily[] = [
  ...
  { name: 'Meridian Ecliptic Heavy Bomber', manifest: 'meridian-vehicles.json', sourceDir: 'meridian', key: 'meridian_ecliptic', file: 'ecliptic-heavy-bomber.glb', stem: 'ecliptic-heavy-bomber' },
  ...
  { name: 'Reclamation Scrapvulture Heavy Bomber', manifest: 'reclamation-vehicles.json', sourceDir: 'reclamation', key: 'reclaim_scrapvulture', file: 'scrapvulture-heavy-bomber.glb', stem: 'scrapvulture-heavy-bomber' },
