...
describe('the upgrade layer is PvP-safe by construction', () => {
  it('never imports the progression unlock gate', () => {
    ...
    const src = read('apps/game/src/sim/Upgrades.ts');
  ...
  it('is written by exactly one function', () => {
    ...
    for (const rel of [
      'apps/game/src/sim/Production.ts', 'apps/game/src/sim/Combat.ts', 'apps/game/src/sim/Damage.ts',
      'apps/game/src/sim/Movement.ts', 'apps/game/src/sim/Vision.ts', 'apps/game/src/sim/Harvesting.ts',
      'apps/game/src/sim/BuildQueue.ts', 'apps/game/src/ui/Sidebar.ts', 'apps/game/src/ui/Hud.ts',
    ]) {
      const src = read(rel);
