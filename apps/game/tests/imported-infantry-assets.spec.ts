...
describe('shared authored infantry runtime', () => {
  it('maps four shared bodies, four commanders and three aquatic bodies to all nineteen roles', () => {
    expect(IMPORTED_INFANTRY_FAMILIES).toHaveLength(11);
