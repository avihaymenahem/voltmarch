...
const HUD_CSS = stripComments(readFileSync(join(ROOT, 'apps/game/src/ui/hud.css'), 'utf8'));
const SHELL_CSS = stripComments(readFileSync(join(ROOT, 'apps/game/src/shell/shell.css'), 'utf8'));
const POST_TS = stripComments(readFileSync(join(ROOT, 'apps/game/src/render/post.ts'), 'utf8'));
...
for (const [name, css] of [
  ['apps/game/src/ui/hud.css', HUD_CSS],
  ['apps/game/src/shell/shell.css', SHELL_CSS],
] as const) {
...
describe('the unblurred surface is tuned, not just the blurred one minus the blur', () => {
  const cases = [
    ['apps/game/src/ui/hud.css', HUD_CSS, '--vm-glass'],
    ['apps/game/src/ui/hud.css', HUD_CSS, '--vm-glass-deep'],
    ['apps/game/src/shell/shell.css', SHELL_CSS, '--vm-glass'],
    ['apps/game/src/shell/shell.css', SHELL_CSS, '--vm-glass-strong'],
  ] as const;
