...
export const IMPORTED_UNIT_SPECS: readonly ImportedUnitSpec[] = [
  ...
  },
  {
    ...
    hullName: 'Hull',
    turretName: 'Turret',
    sourceTurretPivot: [0.175875, 0.05, -0.000215],
    target: [3.2, 2.5, 6.6],
    yawDeg: 90,
    baseColorGain: 1.06,
    roughnessGain: 1.18,
  ...
  },
  {
    ...
    hullName: 'Hull',
    turretName: 'Emitter',
    sourceTurretPivot: [0.111948, 0.05, -0.004046],
    target: [3.0, 2.6, 6.4],
    yawDeg: 90,
    baseColorGain: 1.06,
    roughnessGain: 1.16,
  ...
  {
    key: 'meridian_solarch',
    label: 'Meridian Solarch',
    url: new URL('../../../../packages/assets/game/units/meridian/compressed/solarch.glb', import.meta.url).href,
    shadowUrl: new URL(
      '../../../../packages/assets/game/units/meridian/derived/solarch.shadow.glb', import.meta.url,
    ).href,
    hullName: 'Hull',
    turretName: 'Turret',
    sourceTurretPivot: [-0.134305, 0.05, -0.000768],
    target: [3.1, 2.5, 6.4],
    yawDeg: 90,
    baseColorGain: 1.08,
    roughnessGain: 1.16,
  ...
  {
    key: 'meridian_skiff',
    label: 'Meridian Sandskiff',
    url: new URL('../../../../packages/assets/game/units/meridian/compressed/sandskiff.glb', import.meta.url).href,
    shadowUrl: new URL(
      '../../../../packages/assets/game/units/meridian/derived/sandskiff.shadow.glb', import.meta.url,
    ).href,
    hullName: 'Hull',
    turretName: 'Turret',
    sourceTurretPivot: [0.099407, 0.05, -0.000773],
    target: [2.8, 2.35, 5.4],
    yawDeg: 90,
    baseColorGain: 1.08,
    roughnessGain: 1.16,
  ...
  {
    key: 'meridian_zenith',
    label: 'Meridian Zenith Emitter',
    url: new URL('../../../../packages/assets/game/units/meridian/compressed/zenith-emitter.glb', import.meta.url).href,
    shadowUrl: new URL(
      '../../../../packages/assets/game/units/meridian/derived/zenith-emitter.shadow.glb', import.meta.url,
    ).href,
    hullName: 'Hull',
    turretName: 'Emitter',
    sourceTurretPivot: [-0.08, 0.05, 0],
    target: [3.0, 2.65, 6.6],
    yawDeg: 90,
    baseColorGain: 1.08,
    roughnessGain: 1.14,
