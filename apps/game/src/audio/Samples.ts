...
export const VOICE_MANIFEST: Readonly<Record<string, number>> = {
  // Original VOLTMARCH faction pack. Stable ids follow
  // docs/voice/PHASE2_CASTING_BIBLE.md; files are produced by
  // tools/prepare-voice-pack.py and retain exact per-take transcripts.
  'al-arm.select': 3, 'al-arm.move': 3, 'al-arm.attack': 3, 'al-arm.underFire': 3,
  'sv-arm.select': 3, 'sv-arm.move': 3, 'sv-arm.attack': 3, 'sv-arm.underFire': 3,
  'mr-arm.select': 3, 'mr-arm.move': 3, 'mr-arm.attack': 3, 'mr-arm.underFire': 3,
  'rc-arm.select': 3, 'rc-arm.move': 3, 'rc-arm.attack': 3, 'rc-arm.underFire': 3,
  'al-inf-a.select': 4, 'al-inf-a.move': 4, 'al-inf-a.attack': 4,
  'al-inf-a.underFire': 3, 'al-inf-a.deploy': 2,
  'al-inf-b.select': 4, 'al-inf-b.move': 4, 'al-inf-b.attack': 4,
  'al-inf-b.underFire': 3, 'al-inf-b.deploy': 2,
  'sv-inf-a.select': 4, 'sv-inf-a.move': 4, 'sv-inf-a.attack': 4,
  'sv-inf-a.underFire': 3, 'sv-inf-a.deploy': 2,
  'sv-inf-b.select': 4, 'sv-inf-b.move': 4, 'sv-inf-b.attack': 4,
  'sv-inf-b.underFire': 3, 'sv-inf-b.deploy': 2,
  'mr-inf-a.select': 4, 'mr-inf-a.move': 4, 'mr-inf-a.attack': 4,
  'mr-inf-a.underFire': 3, 'mr-inf-a.deploy': 2,
  'mr-inf-b.select': 4, 'mr-inf-b.move': 4, 'mr-inf-b.attack': 4,
  'mr-inf-b.underFire': 3, 'mr-inf-b.deploy': 2,
  'rc-inf-a.select': 4, 'rc-inf-a.move': 4, 'rc-inf-a.attack': 4,
  'rc-inf-a.underFire': 3, 'rc-inf-a.deploy': 2,
  'rc-inf-b.select': 4, 'rc-inf-b.move': 4, 'rc-inf-b.attack': 4,
  'rc-inf-b.underFire': 3, 'rc-inf-b.deploy': 2,
  'al-harv.select': 3, 'al-harv.move': 3, 'al-harv.stop': 2,
  'al-harv.underFire': 3, 'al-harv.criticalDamage': 2,
  'al-harv.harvest': 3, 'al-harv.cargoFull': 3, 'al-harv.returnToRefinery': 3,
  'sv-harv.select': 3, 'sv-harv.move': 3, 'sv-harv.stop': 2,
  'sv-harv.underFire': 3, 'sv-harv.criticalDamage': 2,
  'sv-harv.harvest': 3, 'sv-harv.cargoFull': 3, 'sv-harv.returnToRefinery': 3,
  'mr-harv.select': 3, 'mr-harv.move': 3, 'mr-harv.stop': 2,
  'mr-harv.underFire': 3, 'mr-harv.criticalDamage': 2,
  'mr-harv.harvest': 3, 'mr-harv.cargoFull': 3, 'mr-harv.returnToRefinery': 3,
  'rc-harv.select': 3, 'rc-harv.move': 3, 'rc-harv.stop': 2,
  'rc-harv.underFire': 3, 'rc-harv.criticalDamage': 2,
  'rc-harv.harvest': 3, 'rc-harv.cargoFull': 3, 'rc-harv.returnToRefinery': 3,
  'al-build.select': 3, 'al-build.move': 3, 'al-build.stop': 2,
  'al-build.underFire': 3, 'al-build.criticalDamage': 2, 'al-build.deploy': 3,
  'sv-build.select': 3, 'sv-build.move': 3, 'sv-build.stop': 2,
  'sv-build.underFire': 3, 'sv-build.criticalDamage': 2, 'sv-build.deploy': 3,
  'mr-build.select': 3, 'mr-build.move': 3, 'mr-build.stop': 2,
  'mr-build.underFire': 3, 'mr-build.criticalDamage': 2, 'mr-build.deploy': 3,
  'rc-build.select': 3, 'rc-build.move': 3, 'rc-build.stop': 2,
  'rc-build.underFire': 3, 'rc-build.criticalDamage': 2, 'rc-build.deploy': 3,
  'al-spec.select': 4, 'al-spec.move': 3, 'al-spec.stop': 2,
  'al-spec.underFire': 3, 'al-spec.criticalDamage': 2, 'al-spec.capture': 3, 'al-spec.repair': 3,
  'sv-spec.select': 4, 'sv-spec.move': 3, 'sv-spec.stop': 2,
  'sv-spec.underFire': 3, 'sv-spec.criticalDamage': 2, 'sv-spec.capture': 3, 'sv-spec.repair': 3,
  'mr-spec.select': 4, 'mr-spec.move': 3, 'mr-spec.stop': 2,
  'mr-spec.underFire': 3, 'mr-spec.criticalDamage': 2, 'mr-spec.capture': 3, 'mr-spec.repair': 3,
  'rc-spec.select': 4, 'rc-spec.move': 3, 'rc-spec.stop': 2,
  'rc-spec.underFire': 3, 'rc-spec.criticalDamage': 2, 'rc-spec.capture': 3, 'rc-spec.repair': 3,
  'al-trans.select': 4, 'al-trans.move': 3, 'al-trans.attack': 3, 'al-trans.stop': 2,
  'al-trans.guard': 2, 'al-trans.patrol': 2, 'al-trans.underFire': 3,
  'al-trans.criticalDamage': 2, 'al-trans.unload': 3,
  'sv-trans.select': 4, 'sv-trans.move': 3, 'sv-trans.attack': 3, 'sv-trans.stop': 2,
  'sv-trans.guard': 2, 'sv-trans.patrol': 2, 'sv-trans.underFire': 3,
  'sv-trans.criticalDamage': 2, 'sv-trans.unload': 3,
  'mr-trans.select': 4, 'mr-trans.move': 3, 'mr-trans.attack': 3, 'mr-trans.stop': 2,
  'mr-trans.guard': 2, 'mr-trans.patrol': 2, 'mr-trans.underFire': 3,
  'mr-trans.criticalDamage': 2, 'mr-trans.unload': 3,
  'rc-trans.select': 4, 'rc-trans.move': 3, 'rc-trans.attack': 3, 'rc-trans.stop': 2,
  'rc-trans.guard': 2, 'rc-trans.patrol': 2, 'rc-trans.underFire': 3,
  'rc-trans.criticalDamage': 2, 'rc-trans.unload': 3,
...
export const EVA_MANIFEST: Readonly<Record<string, number>> = {
  ...
  constructionComplete: 1, forcesUnderAttack: 1, harvesterIdle: 1,
  incomingMissile: 1,
  insufficientFunds: 1, lowPower: 1, missionAccomplished: 1, missionFailed: 1,
  newConstructionOptions: 1, newRallyPoint: 1, noOreMiner: 1,
  nuclearMissileLaunched: 1,
