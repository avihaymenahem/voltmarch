 ...
 *
 * RECORDED-FIRST, SYNTH-SAFE. SampleBank decodes the shipped CC0/owned takes;
 * a SoundSpec without a take falls back to its deterministic oscillator/noise
 * recipe. Either source is baked into the same bounded runtime buffers.
 *
