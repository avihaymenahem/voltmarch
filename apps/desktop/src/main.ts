...
/* -------------------------------------------------------------------------- */
/* 1. Where the shared game client lives                                       */
/* -------------------------------------------------------------------------- */

/**
 * `dist/` is the UNMODIFIED output of the root `vite build` — the shared client
 * bytes packaged for desktop. Nothing in this directory is generated by the desktop
...
function createWindow(): BrowserWindow {
  ...
  const win = new BrowserWindow({
    ...
    // The shared client paints its own boot curtain; showing before first paint
 ...
 * A MATCH. Three renderer-initiated navigations exist in the shared client and all
