...
- **Original soundtrack:** "Silent Horizon", "Disciplined Ostinato", and
  ...
  former CC-BY score, which is no longer included in the distribution.
- **Faction unit voice packs:** eighty-two original armour and infantry acknowledgements
  were generated by the project owner under a paid ElevenLabs account, then
  trimmed, level-matched, resampled and encoded locally. Exact transcripts,
  source and delivery hashes, container details and processing parameters are
  recorded in [`docs/voice/generated/AL-ARM_v1.json`](docs/voice/generated/AL-ARM_v1.json),
  [`docs/voice/generated/SV-ARM_v1.json`](docs/voice/generated/SV-ARM_v1.json),
  [`docs/voice/generated/MR-ARM_v1.json`](docs/voice/generated/MR-ARM_v1.json),
  [`docs/voice/generated/RC-ARM_v1.json`](docs/voice/generated/RC-ARM_v1.json),
  [`docs/voice/generated/AL-INF-A_v1.json`](docs/voice/generated/AL-INF-A_v1.json), and
  [`docs/voice/generated/AL-INF-B_v1.json`](docs/voice/generated/AL-INF-B_v1.json), and
  [`docs/voice/generated/SV-INF-A_v1.json`](docs/voice/generated/SV-INF-A_v1.json), and
  [`docs/voice/generated/SV-INF-B_v1.json`](docs/voice/generated/SV-INF-B_v1.json), and
  [`docs/voice/generated/MR-INF-A_v1.json`](docs/voice/generated/MR-INF-A_v1.json), and
  [`docs/voice/generated/MR-INF-B_v1.json`](docs/voice/generated/MR-INF-B_v1.json), and
  [`docs/voice/generated/RC-INF-A_v1.json`](docs/voice/generated/RC-INF-A_v1.json), and
  [`docs/voice/generated/RC-INF-B_v1.json`](docs/voice/generated/RC-INF-B_v1.json).
