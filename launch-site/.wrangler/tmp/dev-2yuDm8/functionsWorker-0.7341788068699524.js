...
// .wrangler/tmp/pages-9MMs4Z/functionsWorker-0.7341788068699524.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var EMAIL_PATTERN = /^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/u;
var ALLOWED_SOURCES = /* @__PURE__ */ new Set(["hero", "footer", "site"]);
var json = /* @__PURE__ */ __name2((body, status = 200) => new Response(JSON.stringify(body), { status, headers: { "content-type": "application/json; charset=utf-8", "cache-control": "no-store", "x-content-type-options": "nosniff" } }), "json");
var schemaReady;
var ensureSchema = /* @__PURE__ */ __name2((database) => {
...
async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    const result = await env.WAITLIST.prepare("INSERT OR IGNORE INTO subscribers (email, created_at, source) VALUES (?1, ?2, ?3)").bind(email, (/* @__PURE__ */ new Date()).toISOString(), source).run();
...
function onRequest({ request }) {
  return json({ error: `Method ${request.method} is not allowed.` }, 405);
}
...
// .wrangler/tmp/bundle-lUm5zN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lUm5zN/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7341788068699524.js.map
