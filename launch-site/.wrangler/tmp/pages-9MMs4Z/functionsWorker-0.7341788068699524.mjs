...
var json = /* @__PURE__ */ __name((body, status = 200) => new Response(JSON.stringify(body), { status, headers: { "content-type": "application/json; charset=utf-8", "cache-control": "no-store", "x-content-type-options": "nosniff" } }), "json");
var schemaReady;
var ensureSchema = /* @__PURE__ */ __name((database) => {
...
// ../.wrangler/tmp/pages-9MMs4Z/functionsRoutes-0.6970939968446356.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-SqxiAi/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-SqxiAi/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7341788068699524.mjs.map
