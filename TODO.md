...
- **#66 — Phases 6-7. 32 of a planned 37 operations are authored; 5 remain.** Chapters run
  9 / 9 / 9 / 5 (Soviets, Allies, Pact, Reclamation) for 537 minutes of authored par against a
  ...
  9 / 9 / 9 / 10, so what remains is 5 Reclamation and nothing else. **180-320 person-hours for the whole
...
- **NO OPERATION PAST S1 HAS BEEN PLAYED BY A HUMAN.** Thirty-one are authored, adversarially verified
