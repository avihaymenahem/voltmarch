...
const SHOTS = [
  ...
  {
    name: '07c-meridian-support',
    caption: 'Meridian support architecture: Oculus, Pharos, Reliquary, Solar Infirmary and Slipway.',
    flags: { shot: 'meridian-support', seed: 7 },
    pose: [['focusOn', MAP_CENTER, MAP_CENTER, 44], ['setUiVisible', false]],
    camera: { distance: 44, pitchDeg: 46.5337 },
  },
  {
    name: '07d-meridian-final',
    caption: 'Meridian final architecture: Sun Vault, Helios Spire, Rampart and Heliograph.',
    flags: { shot: 'meridian-final', seed: 7 },
    pose: [['focusOn', MAP_CENTER, MAP_CENTER, 48], ['setUiVisible', false]],
    camera: { distance: 48, pitchDeg: 46.8588 },
  },
  {
    name: '07e-reclamation-base',
    caption: 'Reclamation base. Asymmetric salvage architecture, dark steel, violet armor and amber hazards.',
    flags: { shot: 'reclamation-base', seed: 7 },
    pose: [['focusOn', MAP_CENTER, MAP_CENTER, 62], ['setUiVisible', false]],
    camera: { distance: 62, pitchDeg: 48.4558 },
  },
  {
    name: '07f-architecture-showcase',
    caption: 'Every structure from all four factions, role-aligned in one architecture comparison map.',
    flags: { shot: 'architecture-showcase', seed: 7 },
    pose: [['focusOn', MAP_CENTER, MAP_CENTER - 40, 140], ['setUiVisible', false]],
    camera: { distance: 140, pitchDeg: 58.0000 },
  },
  {
    name: '07g-reclamation-lod-audit',
    caption: 'Reclamation structures beyond every authored LOD threshold.',
    flags: { shot: 'reclamation-base', seed: 7 },
    pose: [['focusOn', MAP_CENTER, MAP_CENTER, 100], ['setUiVisible', false]],
    camera: { distance: 100, pitchDeg: 54.3937 },
  },
  {
    name: '08-naval-water',
