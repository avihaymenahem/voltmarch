...
const SIDEBAR = readFileSync(join(ROOT, 'src/ui/Sidebar.ts'), 'utf8');
const INPUT = readFileSync(join(ROOT, 'src/input/input.system.ts'), 'utf8');
const CSS = readFileSync(join(ROOT, 'src/ui/hud-redesign.css'), 'utf8');
