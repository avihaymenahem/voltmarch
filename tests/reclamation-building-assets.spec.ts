...
const report = JSON.parse(fs.readFileSync(
  path.resolve('src/assets/buildings/reclamation/derived/optimization-report.json'),
  'utf8',
)) as { family: string; write: boolean; rows: AssetRow[] };
const runtime = fs.readFileSync(path.resolve('src/art/Faction4Buildings.ts'), 'utf8');
